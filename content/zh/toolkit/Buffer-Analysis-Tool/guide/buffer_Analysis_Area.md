...
> [!NOTE]
> 确保 **[选择源兴趣点（POI）的区域名称字段](#选择源兴趣点poi的区域名称字段)** 和 **[选择区域图层的区域名称字段](#选择区域图层的区域名称字段)** 中的值对应相同的区域。强烈建议使用 [区域划分脚本](../district_divid) 从 **[区域图层](#区域图层)** 为 **[源兴趣点（POI）图层](#源兴趣点poi图层)** 生成区域名称字段。
