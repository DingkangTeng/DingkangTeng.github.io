...
summary: This study provides a decadal assessment of public EV charging infrastructure in China, introducing the Optimal level of Accessibility (Opt-Acc) index to reveal that while accessibility levels have converged and equity has improved in most cities, a widening spatial imbalance still existes.

tags:
- Electric vehicle charging station (EVCS)
- Optimal level of Accessibility (Opt-Acc)
...
links:
- type: code
  url: https://github.com/DingkangTeng/China-EVCS-Accessibility-and-Equity
- type: dataset
  url: https://globalevdata.github.io/data.html
# - type: custom
#   label: ToolKit
